...
public enum DatabaseType {
    ...
    POSTGRESQL("postgresql",
            ...
            "SELECT table_name FROM information_schema.tables WHERE table_catalog=? AND table_schema='public' and table_name like concat('v_%',?,'%_gc%')",
            "SELECT table_name, column_name, data_type, character_maximum_length, is_nullable, column_default,udt_name FROM information_schema.columns WHERE table_schema ='public' AND table_name=?",
    ...
    private DatabaseType(String name, String driver, String sequence, String createConfigQuery, String queryTable, String queryCheckViews, String queryColumn, String queryConstraint, String[] valuequeryConstraint, String foreignKeyQuery, String[] valueforeignKeyQuery, String primaryKeyQuery, String limit) {
        this.setName(name);
